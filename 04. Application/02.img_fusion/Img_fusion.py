#image fusion using wavelet transform // PyWavelet 
...
# Read the two image
I1 = cv2.imread('cam.jpg',0)
I2 = cv2.imread('boat.512.tiff',0)
...
# Displaying  OutPUT
images = [I1,  I2, fusedImage ]
imageTitles = ['1st_img','2nd_img','fused_Img']
